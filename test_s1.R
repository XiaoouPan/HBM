...
early1 = as.matrix(read.csv("~/Dropbox/Mayo-intern/Simulation/Results/early1_resp_mix.csv")[, -1])
early2 = as.matrix(read.csv("~/Dropbox/Mayo-intern/Simulation/Results/early2_acti_mix.csv")[, -1])

setwd("~/Dropbox/Mayo-intern/Simulation")
tikz("plot.tex", standAlone = TRUE, width = 6, height = 5)
plot(epsilon_seq, early1[1, ], type = "b", pch = 20, lwd = 5, cex = 1, axes = FALSE, ylim = c(0.2, 0.9), xlab = "", ylab = "")
...
axis(2, c(0.2, 0.4, 0.6, 0.8), line = 0, cex.axis = 1.5)
box()
abline(h = c(0.2, 0.4, 0.6, 0.8), v = epsilon_seq[c(1, 6, 11, 16)], col = "gray", lty = 2)
...
tikz("plot.tex", standAlone = TRUE, width = 6, height = 5)
plot(epsilon_seq, 1 - early2[1, ], type = "b", pch = 20, lwd = 5, cex = 1, axes = FALSE, ylim = c(0, 1), xlab = "", ylab = "")
...
axis(2, c(0, 0.25, 0.5, 0.75, 1), line = 0, cex.axis = 1.5)
box()
abline(h = c(0, 0.25, 0.5, 0.75, 1), v = epsilon_seq[c(1, 6, 11, 16, 21)], col = "gray", lty = 2)
title(xlab = "Buffer $\\epsilon$", line = 3, cex.lab = 2)
title(ylab = "Early stopping rate", line = 2.2, cex.lab = 1.6)
dev.off()
tools::texi2dvi("plot.tex", pdf = T)
