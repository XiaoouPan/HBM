...
early1 = as.matrix(read.csv("~/Dropbox/Mayo-intern/Simulation/Results/early1_acti_mode.csv")[, -1])
early2 = as.matrix(read.csv("~/Dropbox/Mayo-intern/Simulation/Results/early2_acti_mode.csv")[, -1])

setwd("~/Dropbox/Mayo-intern/Simulation")
tikz("plot.tex", standAlone = TRUE, width = 6, height = 5)
plot(epsilon_seq, early1[1, ], type = "b", pch = 20, lwd = 5, cex = 1, axes = FALSE, ylim = c(0, 1), xlab = "", ylab = "")
